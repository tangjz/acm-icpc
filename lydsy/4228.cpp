#pragma GCC optimize("-fdelete-null-pointer-checks,inline-functions-called-once,-funsafe-loop-optimizations,-fexpensive-optimizations,-foptimize-sibling-calls,-ftree-switch-conversion,-finline-small-functions,inline-small-functions,-frerun-cse-after-loop,-findirect-inlining,-freorder-functions,no-stack-protector,-fsched-interblock,-fcse-follow-jumps,-fcse-skip-blocks,-falign-functions,-fstrict-overflow,-fstrict-aliasing,-fschedule-insns2,inline-functions,-fschedule-insns,-freorder-blocks,-fwhole-program,-funroll-loops,-fthread-jumps,-fcrossjumping,-fcaller-saves,-falign-labels,-falign-loops,-falign-jumps,unroll-loops,-fsched-spec,-ffast-math,inline,-fgcse,-fgcse-lm,-ftree-pre,-ftree-vrp,-fpeephole2",3)
#pragma GCC target("avx","sse2")
#include <stdio.h>
#include <cstring>
#include <algorithm>
typedef long long LL;
const int maxLen = 20, maxs = 1 << maxLen | 1, mod = 1004535809, gen = 3, inv2 = (mod + 1) >> 1;
...
int main() {
	...
	f[2] = inv2;
	for(int i = 3; i <= n; ++i)
		f[i] = i % 3 > 0 ? (inv[i] + 1LL) * inv2 % mod : inv2;
	polyExp(n + 1, f, g);
	int ans = g[n];
	for(int i = 2; i <= n; ++i)
		ans = (LL)ans * i % mod;
